...
COPY src/predict.modules.ts /app/predict/predict.modules.ts
COPY src/predict/predict.component.ts /app/predict/predict.component.ts
COPY src/predict/predict.component.html /app/predict/predict.component.html 
